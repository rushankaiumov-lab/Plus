  ...
  var scenarios = [
    {
      ...
      state: { hasPaymentMethod: false, isTrial: true, showAddPaymentMethodSheet: true, animateSavingsCounter: true },
      variants: {
    ...
    },
    {
      ...
      state: { hasPaymentMethod: true, isTrial: false, animateSavingsCounter: true },
      variants: {
    ...
    },
    {
      ...
      entry: { screen: 'subscription' },
      state: { hasPaymentMethod: true, isTrial: true, animateSavingsCounter: true },
      variants: {
        A: { id: 'A', title: 'Control structure' },
        B: { id: 'B', title: 'Alternative structure' },
        C: { id: 'C', title: 'Compressed structure' }
