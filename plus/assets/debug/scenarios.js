  ...
  var scenarios = [
    {
      ...
      state: { hasPaymentMethod: false, isTrial: true, showAddPaymentMethodSheet: true, trialTokenizeCard: true, animateSavingsCounter: true, animateSavingsStart: '1019.97', animateSavingsDelta: '', hasTabbyCash: false, hasCashbackActive: false, hasCashbackSecondCardIssued: false, cashbackPartlySelectedCard: 'tabby-cash' },
      variants: {
    ...
    },
    {
      ...
      state: { hasPaymentMethod: true, isTrial: false, trialTokenizeCard: true, animateSavingsCounter: true, animateSavingsStart: '1019.97', animateSavingsDelta: '', hasTabbyCash: false, hasCashbackActive: false, hasCashbackSecondCardIssued: false, cashbackPartlySelectedCard: 'tabby-cash' },
      variants: {
    ...
    },
    {
      ...
      entry: { screen: 'subscription' },
      state: { hasPaymentMethod: true, isTrial: true, trialTokenizeCard: true, animateSavingsCounter: true, animateSavingsStart: '1019.97', animateSavingsDelta: '', hasTabbyCash: false, hasCashbackActive: false, hasCashbackSecondCardIssued: false, cashbackPartlySelectedCard: 'tabby-cash' },
      variants: {
        A: { id: 'A', title: 'Control structure' },
        B: { id: 'B', title: 'Alternative structure' },
        C: { id: 'C', title: 'Compressed structure' }
