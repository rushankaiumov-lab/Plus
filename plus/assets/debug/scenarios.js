  ...
  var scenarios = [
    {
      ...
      state: { hasPaymentMethod: false, isTrial: true, showAddPaymentMethodSheet: true, animateSavingsCounter: true, animateSavingsStart: '1019.97', animateSavingsDelta: '' },
      variants: {
    ...
    },
    {
      ...
      state: { hasPaymentMethod: true, isTrial: false, animateSavingsCounter: true, animateSavingsStart: '1019.97', animateSavingsDelta: '' },
      variants: {
    ...
    },
    {
      ...
      entry: { screen: 'subscription' },
      state: { hasPaymentMethod: true, isTrial: true, animateSavingsCounter: true, animateSavingsStart: '1019.97', animateSavingsDelta: '' },
      variants: {
        A: { id: 'A', title: 'Control structure' },
        B: { id: 'B', title: 'Alternative structure' },
        C: { id: 'C', title: 'Compressed structure' }
